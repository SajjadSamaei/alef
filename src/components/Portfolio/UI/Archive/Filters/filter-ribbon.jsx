...
import FilterCategories from "@/components/Portfolio/UI/Archive/Filters/FilterCategories";
import FilterStatus from "@/components/Portfolio/UI/Archive/Filters/FilterStatus";
import { ProjectFiltersMobile } from "@/components/Portfolio/UI/Archive/Filters/filters-mobile-ui";
import FilterYear from "@/components/Portfolio/UI/Archive/Filters/FilterYear";
import { SearchBar } from "@/components/Portfolio/UI/Archive/Search/search";
import Sort from "@/components/Portfolio/UI/Archive/Filters/sort";
...
export const PortfolioFilterRibbon = () => {
    ...
    >
      <Popover>
        ...
        <PopoverContent
          ...
          align="center"
          sideOffset={8}
          className="w-[92vw] overflow-hidden rounded-3xl border border-white/10 bg-white/95 p-0 shadow-2xl backdrop-blur-xl lg:hidden dark:bg-neutral-900/95"
        >
