...
import ChegallLogo from "@/public/logos/chegall/typography-black.svg";
...
function MainLogo() {
  return (
    <div className="absolute top-32 left-44 flex size-16 items-center justify-center rounded-full bg-white shadow-sm ring-1 ring-black/5">
      <ChegallLogo className="h-9 fill-black" />
    </div>
  );
}
  ...
  return (
    <div aria-hidden="true" className="h-full overflow-hidden">
      ...
      <div className="absolute left-1/2 h-full w-[26rem] -translate-x-1/2">
        <MainLogo />
        <Logo
          src="/logos/jaroun/logomark-dark.svg"
          left={360}
          top={144}
        ...
        <Logo
          src="/logos/nirvana/nirvana-dark.svg"
          left={285}
          top={20}
          hover={{ x: 4, y: -5, rotate: 6, delay: 0.3 }}
        />
        <Logo
          src="/logos/dey/dey-logo-3.svg"
          left={255}
          top={210}
          hover={{ x: 3, y: 5, rotate: 7, delay: 0.2 }}
        />
        <Logo
          src="/logos/ka/logo-dark.svg"
          left={144}
          top={40}
          hover={{ x: -2, y: -5, rotate: -6, delay: 0.15 }}
        />
        <Logo
          src="/logos/anahita/anahita-dark.svg"
          left={36}
          top={56}
          hover={{ x: -4, y: -5, rotate: -6, delay: 0.35 }}
        />
        <Logo
          src="/logos/baharestan/baharestan-logo.svg"
          left={96}
          top={176}
