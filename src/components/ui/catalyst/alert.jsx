            ...
            >
              <Headless.DialogPanel
                className={clsx(
                  className,
                  sizes[size],
                  "row-start-2 w-full rounded-2xl bg-[#f6f8fc] p-8 shadow-lg ring-1 ring-zinc-950/10 sm:rounded-2xl sm:p-6 dark:bg-zinc-900 dark:ring-white/10 forced-colors:outline",
                )}
              >
                {children}
              </Headless.DialogPanel>
