...
const styles = {
  base: [
    // Base
    "relative isolate inline-flex items-center justify-center gap-x-2 rounded-[40px] text-base/6 font-semibold",
    // Sizing
  ...
  solid: [
    ...
    "before:absolute before:inset-0 before:-z-10 before:rounded-[40px] before:bg-(--btn-bg)",
    ...
    "after:absolute after:inset-0 after:-z-10 after:rounded-[40px]",
    // Inner highlight shadow
    "after:shadow-[shadow:inset_0_1px_--theme(--color-white/15%)]",
    // White overlay on hover
    "data-active:after:bg-(--btn-hover-overlay) data-hover:after:bg-(--btn-hover-overlay)",
    // Dark mode: `after` layer expands to cover entire button
    "dark:after:-inset-px dark:after:rounded-[40px]",
    // Disabled
