...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "media" (
  	...
  	"sizes_profile_pic_url" varchar,
  	"sizes_profile_pic_width" numeric,
  	"sizes_profile_pic_height" numeric,
  	"sizes_profile_pic_mime_type" varchar,
  	"sizes_profile_pic_filesize" numeric,
  	"sizes_profile_pic_filename" varchar
  );
  
  CREATE TABLE "blog_media" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"alt" varchar,
  	"custom_folder_path" varchar,
  	"caption" jsonb,
  	"placeholder" varchar,
  	"prefix" varchar DEFAULT 'blog-media',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"url" varchar,
  	"thumbnail_u_r_l" varchar,
  ...
  ALTER TABLE "pages" ADD CONSTRAINT "pages_hero_media_id_blog_media_id_fk" FOREIGN KEY ("hero_media_id") REFERENCES "public"."blog_media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v" ADD CONSTRAINT "_pages_v_version_hero_media_id_blog_media_id_fk" FOREIGN KEY ("version_hero_media_id") REFERENCES "public"."blog_media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "posts" ADD CONSTRAINT "posts_hero_image_id_blog_media_id_fk" FOREIGN KEY ("hero_image_id") REFERENCES "public"."blog_media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_posts_v" ADD CONSTRAINT "_posts_v_version_hero_image_id_blog_media_id_fk" FOREIGN KEY ("version_hero_image_id") REFERENCES "public"."blog_media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "blog_media_sizes_thumbnail_sizes_thumbnail_filename_idx" ON "blog_media" USING btree ("sizes_thumbnail_filename");
  CREATE INDEX "blog_media_sizes_square_sizes_square_filename_idx" ON "blog_media" USING btree ("sizes_square_filename");
  CREATE INDEX "blog_media_sizes_card_sizes_card_filename_idx" ON "blog_media" USING btree ("sizes_card_filename");
  CREATE INDEX "blog_media_sizes_tablet_sizes_tablet_filename_idx" ON "blog_media" USING btree ("sizes_tablet_filename");
  CREATE INDEX "blog_media_sizes_small_sizes_small_filename_idx" ON "blog_media" USING btree ("sizes_small_filename");
  CREATE INDEX "blog_media_sizes_medium_sizes_medium_filename_idx" ON "blog_media" USING btree ("sizes_medium_filename");
  CREATE INDEX "blog_media_sizes_large_sizes_large_filename_idx" ON "blog_media" USING btree ("sizes_large_filename");
  CREATE INDEX "blog_media_sizes_xlarge_sizes_xlarge_filename_idx" ON "blog_media" USING btree ("sizes_xlarge_filename");
  CREATE INDEX "blog_media_sizes_og_sizes_og_filename_idx" ON "blog_media" USING btree ("sizes_og_filename");
  CREATE INDEX "blog_media_sizes_twitter_sizes_twitter_filename_idx" ON "blog_media" USING btree ("sizes_twitter_filename");
