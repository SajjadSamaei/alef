...
export const enum_people_role = pgEnum("enum_people_role", ["user", "admin"]);
...
export const pages_hero_links = pgTable(
  "pages_hero_links",
  {
    ...
    link_customId: varchar("link_custom_id"),
    link_appearance:
...
export const pages = pgTable(
  "pages",
  {
    ...
    hero_media: integer("hero_media_id").references(() => blog_media.id, {
      onDelete: "set null",
    }),
...
export const posts = pgTable(
  "posts",
  {
    ...
    heroImage: integer("hero_image_id").references(() => blog_media.id, {
      onDelete: "set null",
    }),
    content: jsonb("content"),
    meta_title: varchar("meta_title"),
    meta_image: integer("meta_image_id").references(() => blog_media.id, {
      onDelete: "set null",
    }),
    meta_description: varchar("meta_description"),
    publishedAt: timestamp("published_at", {
...
export const media = pgTable(
  "media",
  {
    ...
    sizes_profile_pic_url: varchar("sizes_profile_pic_url"),
    sizes_profile_pic_width: numeric("sizes_profile_pic_width"),
    sizes_profile_pic_height: numeric("sizes_profile_pic_height"),
    sizes_profile_pic_mimeType: varchar("sizes_profile_pic_mime_type"),
    sizes_profile_pic_filesize: numeric("sizes_profile_pic_filesize"),
    sizes_profile_pic_filename: varchar("sizes_profile_pic_filename"),
  },
  (columns) => ({
    ...
    media_sizes_profile_pic_sizes_profile_pic_filename_idx: index(
      "media_sizes_profile_pic_sizes_profile_pic_filename_idx",
    ).on(columns.sizes_profile_pic_filename),
  }),
);

export const blog_media = pgTable(
  "blog_media",
  {
    id: serial("id").primaryKey(),
    alt: varchar("alt"),
    customFolderPath: varchar("custom_folder_path"),
    caption: jsonb("caption"),
    placeholder: varchar("placeholder"),
    prefix: varchar("prefix").default("blog-media"),
    updatedAt: timestamp("updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
    ...
    sizes_og_filesize: numeric("sizes_og_filesize"),
    sizes_og_filename: varchar("sizes_og_filename"),
    sizes_twitter_url: varchar("sizes_twitter_url"),
    sizes_twitter_width: numeric("sizes_twitter_width"),
    sizes_twitter_height: numeric("sizes_twitter_height"),
    sizes_twitter_mimeType: varchar("sizes_twitter_mime_type"),
    sizes_twitter_filesize: numeric("sizes_twitter_filesize"),
    sizes_twitter_filename: varchar("sizes_twitter_filename"),
  },
  (columns) => ({
    blog_media_updated_at_idx: index("blog_media_updated_at_idx").on(
      columns.updatedAt,
    ),
    blog_media_created_at_idx: index("blog_media_created_at_idx").on(
      columns.createdAt,
    ),
    blog_media_filename_idx: uniqueIndex("blog_media_filename_idx").on(
      columns.filename,
    ),
    blog_media_sizes_thumbnail_sizes_thumbnail_filename_idx: index(
      "blog_media_sizes_thumbnail_sizes_thumbnail_filename_idx",
    ).on(columns.sizes_thumbnail_filename),
    blog_media_sizes_square_sizes_square_filename_idx: index(
      "blog_media_sizes_square_sizes_square_filename_idx",
    ).on(columns.sizes_square_filename),
    blog_media_sizes_card_sizes_card_filename_idx: index(
      "blog_media_sizes_card_sizes_card_filename_idx",
    ).on(columns.sizes_card_filename),
    blog_media_sizes_tablet_sizes_tablet_filename_idx: index(
      "blog_media_sizes_tablet_sizes_tablet_filename_idx",
    ).on(columns.sizes_tablet_filename),
    blog_media_sizes_small_sizes_small_filename_idx: index(
      "blog_media_sizes_small_sizes_small_filename_idx",
    ).on(columns.sizes_small_filename),
    blog_media_sizes_medium_sizes_medium_filename_idx: index(
      "blog_media_sizes_medium_sizes_medium_filename_idx",
    ).on(columns.sizes_medium_filename),
    blog_media_sizes_large_sizes_large_filename_idx: index(
      "blog_media_sizes_large_sizes_large_filename_idx",
    ).on(columns.sizes_large_filename),
    blog_media_sizes_xlarge_sizes_xlarge_filename_idx: index(
      "blog_media_sizes_xlarge_sizes_xlarge_filename_idx",
    ).on(columns.sizes_xlarge_filename),
    blog_media_sizes_og_sizes_og_filename_idx: index(
      "blog_media_sizes_og_sizes_og_filename_idx",
    ).on(columns.sizes_og_filename),
    blog_media_sizes_twitter_sizes_twitter_filename_idx: index(
      "blog_media_sizes_twitter_sizes_twitter_filename_idx",
    ).on(columns.sizes_twitter_filename),
  }),
);
...
export const people = pgTable(
  "people",
  {
    ...
    name: varchar("name").notNull(),
    email: varchar("email").notNull(),
    role: enum_people_role("role").default("user"),
    updatedAt: timestamp("updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
  ...
  (columns) => ({
    people_email_idx: uniqueIndex("people_email_idx").on(columns.email),
...
export const payload_locked_documents_rels = pgTable(
  "payload_locked_documents_rels",
  {
    ...
    "blog-mediaID": integer("blog_media_id"),
    categoriesID: integer("categories_id"),
    tagsID: integer("tags_id"),
    usersID: integer("users_id"),
  ...
  (columns) => ({
    ...
    payload_locked_documents_rels_blog_media_id_idx: index(
      "payload_locked_documents_rels_blog_media_id_idx",
    ).on(columns["blog-mediaID"]),
    ...
    "blog-mediaIdFk": foreignKey({
      columns: [columns["blog-mediaID"]],
      foreignColumns: [blog_media.id],
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  hero_media: one(blog_media, {
    fields: [pages.hero_media],
    references: [blog_media.id],
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  version_hero_media: one(blog_media, {
...
export const relations_posts = relations(posts, ({ one, many }) => ({
  heroImage: one(blog_media, {
    fields: [posts.heroImage],
    references: [blog_media.id],
    relationName: "heroImage",
  }),
  meta_image: one(blog_media, {
...
export const relations__posts_v = relations(_posts_v, ({ one, many }) => ({
  ...
  version_heroImage: one(blog_media, {
    fields: [_posts_v.version_heroImage],
    references: [blog_media.id],
    relationName: "version_heroImage",
  }),
  version_meta_image: one(blog_media, {
...
export const relations_blog_media = relations(blog_media, () => ({}));
...
export const relations_people = relations(people, () => ({}));
...
export const relations_payload_locked_documents_rels = relations(
  ...
  ({ one }) => ({
    ...
    "blog-mediaID": one(blog_media, {
      fields: [payload_locked_documents_rels["blog-mediaID"]],
      references: [blog_media.id],
      relationName: "blog-media",
    }),
    categoriesID: one(categories, {
...
type DatabaseSchema = {
  ...
  enum_people_role: typeof enum_people_role;
  ...
  relations_blog_media: typeof relations_blog_media;
