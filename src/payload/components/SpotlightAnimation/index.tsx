"use client";
import type { AllowedElements } from "@/payload/components/SpotlightAnimation/types";

import { useResize } from "@/payload/utilities/use-resize";
...
const SpotlightAnimation: React.FC<Props> = ({
  as = "h2",
  children,
  richTextChildren,
}) => {
