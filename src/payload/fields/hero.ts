...
export const hero: Field = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: "group",
      admin: {
        condition: (_, { type, threeCTA }) =>
          type === "three" && threeCTA === "newsletter",
        hideGutter: true,
      },
      fields: [
        {
    ...
    }),
    {
      ...
      admin: {
        condition: (_, { type } = {}) =>
          ["gradient", "homeNew", "three"].includes(type),
      },
      fields: [
        {
          name: "image",
    ...
    },
    {
      ...
      admin: {
        condition: (_, { type, enableMedia } = {}) =>
          ...
          (enableMedia && type === "centeredContent"),
      },
      relationTo: "media",
      required: true,
    },
